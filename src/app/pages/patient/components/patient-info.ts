...
@Component({
    ...
    imports: [CardModule, AvatarModule, SkeletonModule, ButtonModule, FontAwesomeModule, ChipModule, PatientInfoDetails, AccordionModule, FieldsetModule],
    template: `
        <p-card>
            <div class="flex items-center flex-col lg:flex-row lg:justify-between">
                <div class="flex items-start flex-col md:flex-row gap-8">
                    <p-avatar label="NC" class="mr-2 bg-indigo-100! w-[6.4rem]! h-[6.4rem]!" size="xlarge" shape="circle" />
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center flex-wrap gap-10">
                            ...
                            <div>
                                ...
                                <div class="text-surface-700 dark:text-surface-100 mt-1 text-sm font-semibold">M</div>
                            </div>
                            @if (!isOlder) {
                                <div>
                                    <div class="text-surface-700 dark:text-surface-100 mt-1 text-sm font-semibold">
                                        <p-chip class="!py-0 !pl-0 !pr-4">
                                            <span
                                                class="bg-cyan-600 text-primary-contrast rounded-full w-8 h-8 flex items-center justify-center">
            ...
            <div class="flex flex-col mt-2">
                <div class="flex flex-col md:flex-row">
                    <app-patient-info-details class="w-[100%]"/>
                </div>
            </div>
        </p-card>
    `,
